...
module.exports = {
    ...
    dev: ["217389696043450368"], // your Discord user Id & developer user Id
    ...
    rainlinkOptions: {
        ...
        defaultSearchEngine: process.env.DEFAULT_SEARCH_ENGINE || "soundcloud", // default search engine. Available engines: youtubeMusic, youtube,& soundcloud.
        searchFallback: {
            enable: true, // enable search fallback, don't change this if you don't know what you're doing
            engine: process.env.SEARCH_FALLBACK_ENGINE || "youtubeMusic", // search fallback engine, this is the engine that will be used when the default search engine fails and the search fallback is enabled. Available engines: youtubeMusic, youtube, and soundcloud
        },
    },
